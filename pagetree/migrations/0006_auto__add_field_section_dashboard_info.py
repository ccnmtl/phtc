...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.dashboard_info'
        db.add_column('pagetree_section', 'dashboard_info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.dashboard_info'
        db.delete_column('pagetree_section', 'dashboard_info')
    ...
    models = {
        ...
        'pagetree.section': {
            ...
            'dashboard_info': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
