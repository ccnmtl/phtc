...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Section.dashboard_info'
        db.alter_column('pagetree_section', 'dashboard_info', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Section.dashboard_info'
        db.alter_column('pagetree_section', 'dashboard_info', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'pagetree.section': {
            ...
            'dashboard_info': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
