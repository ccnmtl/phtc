function CheckboxActivity($, context){
	...
	// globals
	var that = this;// do this so the context of "this" (instance of the 
	...
	this.submitButton = $('<button type="button" class="submit-button btn btn-secondary">Submit</button>');
	this.clearButton = $('<button type="button" class="clear-button btn btn-secondary">Clear Answers</button>');
	...
	this.createGrid = function(activity){
		...
		wrapper.append('<div id="row-title">' + this.createRowTitle(this.rowTitle) + '</div>');
	...
	this.showAnswerKey = function(){
		var userAnswer = '<div>Your Answer:<span class="user-x"> X</span></div>';
		var correctAnswer = '<div>Correct Answer:<span class="answr-x"> X</span></div>';
		var html = $('<div class="answer-key-wrapper"><div class="user-answers">'+ 
