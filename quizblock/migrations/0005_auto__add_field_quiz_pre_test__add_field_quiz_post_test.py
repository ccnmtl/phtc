...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.pre_test'
        db.add_column('quizblock_quiz', 'pre_test',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Quiz.post_test'
        db.add_column('quizblock_quiz', 'post_test',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quiz.pre_test'
        db.delete_column('quizblock_quiz', 'pre_test')

        # Deleting field 'Quiz.post_test'
        db.delete_column('quizblock_quiz', 'post_test')
