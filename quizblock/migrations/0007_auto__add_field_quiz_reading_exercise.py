...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.reading_exercise'
        db.add_column('quizblock_quiz', 'reading_exercise',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quiz.reading_exercise'
        db.delete_column('quizblock_quiz', 'reading_exercise')
    ...
    models = {
        ...
        'quizblock.quiz': {
            ...
            'reading_exercise': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
