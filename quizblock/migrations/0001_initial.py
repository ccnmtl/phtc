    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(max_length=256, choices=[(b'multiple choice', b'Multiple Choice: Multiple answers'), (b'matching', b'Matching: Match questions with set of answers'), (b'single choice', b'Multiple Choice: Single answer'), (b'single choice feedback', b'Multiple Choice: Single answer with item feedback'), (b'single choice dropdown', b'Multiple Choice: Single answer (dropdown)'), (b'short text', b'Short Text'), (b'long text', b'Long Text')])),
