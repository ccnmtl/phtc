...
class UserRegistrationForm(RegistrationForm):
    ...
    position = forms.CharField(
        label=("Which of the following categories best describes "
               "your primary discipline/specialty?"),
        widget=forms.Select(
            ...
            choices=[
                ...
                ('Behavioral Health |Psychology',
                 'Behavioral Health |Psychology'),
                ('Behavioral Health - Substance use/Addiction Counseling',
                 'Behavioral Health - Substance use/Addiction Counseling'),
                ('Community Health Worker', 'Community Health Worker'),
                ('Dentistry', 'Dentistry'),
                ('Emergency management/emergency preparedness',
                 'Emergency management/emergency preparedness'),
                ('Environmental Health - Environmental chemistry',
                 'Environmental Health - Environmental chemistry'),
                ('Environmental Health - Environmental health planning',
                 'Environmental Health - Environmental health planning'),
                ...
                ('Environmental Health - Occupational safety and health',
                 'Environmental Health - Occupational safety and health'),
                ('Environmental Health - Radiological health',
                 'Environmental Health - Radiological health'),
                ...
                ('EMT-Paramedic/First responder',
                 'EMT-Paramedic/First responder'),
                ('Geriatrics/Aging Populations',
                 'Geriatrics/Aging Populations'),
                ('Global/International Health - Tropical medicine',
                 'Global/International Health - Tropical medicine'),
                ('Health education/behavior - Behavioral sciences',
                 'Health education/behavior - Behavioral sciences'),
                ('Health education/behavior - Community health sciences',
                 'Health education/behavior - Community health sciences'),
                ('Health education/behavior - Evaluation research',
                 'Health education/behavior - Evaluation research'),
                ('Health education/behavior - Health behavior',
                 'Health education/behavior - Health behavior'),
                ...
                ('Health Services/Hospital Administration',
                 'Health Services/Hospital Administration'),
                ('Health Services/Hospital Administration - Health management',
                 ('Health Services/Hospital Administration - '
                  'Health management')),
                ('Health Services/Hospital Administration - Health planning',
                 'Health Services/Hospital Administration - Health planning'),
                (('Health Services/Hospital Administration - '
                ...
                ('Maternal & Child Health - Adolescent health',
                 'Maternal & Child Health - Adolescent health'),
                ('Maternal & Child Health - Infant and child health',
                 'Maternal & Child Health - Infant and child health'),
                ...
                ('Public Health (general studies)',
                 'Public Health (general studies)'),
                ('Public Health Practice - Community health practice',
                 'Public Health Practice - Community health practice'),
