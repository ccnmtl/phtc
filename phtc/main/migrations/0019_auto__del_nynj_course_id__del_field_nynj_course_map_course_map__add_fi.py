...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NYNJ_Course_Map.course_map'
        db.delete_column('main_nynj_course_map', 'course_map_id')

        # Adding field 'NYNJ_Course_Map.courseID'
        db.add_column('main_nynj_course_map', 'courseID',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'NYNJ_Course_Map.course_map'
        db.add_column('main_nynj_course_map', 'course_map',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['main.NYNJ_Course_ID'], unique=True),
                      keep_default=False)

        # Deleting field 'NYNJ_Course_Map.courseID'
        db.delete_column('main_nynj_course_map', 'courseID')
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_nynj': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'lname': ('django.db.models.fields.TextField', [], {}),
            'nynj_course_init': ('django.db.models.fields.TextField', [], {'default': "'none'"}),
            'nynj_user_id': ('django.db.models.fields.TextField', [], {'default': "'none'"}),
            'nynj_username': ('django.db.models.fields.TextField', [], {'default': "'none'"}),
