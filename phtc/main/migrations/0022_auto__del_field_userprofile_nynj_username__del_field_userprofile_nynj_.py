...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.nynj_username'
        db.delete_column('main_userprofile', 'nynj_username')

        # Deleting field 'UserProfile.nynj_course_init'
        db.delete_column('main_userprofile', 'nynj_course_init')

        # Deleting field 'UserProfile.is_nynj'
        db.delete_column('main_userprofile', 'is_nynj')

        # Deleting field 'UserProfile.nynj_user_id'
        db.delete_column('main_userprofile', 'nynj_user_id')

        # Adding field 'UserProfile.is_nylearns'
        db.add_column('main_userprofile', 'is_nylearns',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.nylearns_username'
        db.add_column('main_userprofile', 'nylearns_username',
                      self.gf('django.db.models.fields.TextField')(default='none'),
                      keep_default=False)

        # Adding field 'UserProfile.nylearns_course_init'
        db.add_column('main_userprofile', 'nylearns_course_init',
                      self.gf('django.db.models.fields.TextField')(default='none'),
                      keep_default=False)

        # Adding field 'UserProfile.nylearns_user_id'
        db.add_column('main_userprofile', 'nylearns_user_id',
                      self.gf('django.db.models.fields.TextField')(default='none'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.nynj_username'
        db.add_column('main_userprofile', 'nynj_username',
                      self.gf('django.db.models.fields.TextField')(default='none'),
                      keep_default=False)

        # Adding field 'UserProfile.nynj_course_init'
        db.add_column('main_userprofile', 'nynj_course_init',
                      self.gf('django.db.models.fields.TextField')(default='none'),
                      keep_default=False)

        # Adding field 'UserProfile.is_nynj'
        db.add_column('main_userprofile', 'is_nynj',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.nynj_user_id'
        db.add_column('main_userprofile', 'nynj_user_id',
                      self.gf('django.db.models.fields.TextField')(default='none'),
                      keep_default=False)

        # Deleting field 'UserProfile.is_nylearns'
        db.delete_column('main_userprofile', 'is_nylearns')

        # Deleting field 'UserProfile.nylearns_username'
        db.delete_column('main_userprofile', 'nylearns_username')

        # Deleting field 'UserProfile.nylearns_course_init'
        db.delete_column('main_userprofile', 'nylearns_course_init')

        # Deleting field 'UserProfile.nylearns_user_id'
        db.delete_column('main_userprofile', 'nylearns_user_id')
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'nylearns_username': ('django.db.models.fields.TextField', [], {'default': "'none'"}),
