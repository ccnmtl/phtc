...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NYLEARNS_Course_Map'
        db.create_table('main_nylearns_course_map', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('courseID', self.gf('django.db.models.fields.TextField')()),
            ('phtc_url', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('main', ['NYLEARNS_Course_Map'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NYLEARNS_Course_Map'
        db.delete_table('main_nylearns_course_map')
