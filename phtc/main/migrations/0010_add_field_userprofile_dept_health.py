...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.dept_health'
        db.add_column('main_userprofile', 'dept_health',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.dept_health'
        db.delete_column('main_userprofile', 'dept_health')
