...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.other_employment_location'
        db.add_column('main_userprofile', 'other_employment_location',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.other_employment_location'
        db.delete_column('main_userprofile', 'other_employment_location')
