...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_moduletype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('module_type', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pagetree.Section'], unique=True)),
            ('info', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('main', ['ModuleType'])


    def backwards(self, orm):
        # Deleting model 'ModuleType'
        db.delete_table('main_moduletype')
