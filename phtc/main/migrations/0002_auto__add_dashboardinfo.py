...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DashboardInfo'
        db.create_table('main_dashboardinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pagetree.Section'], unique=True)),
            ('info', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('main', ['DashboardInfo'])


    def backwards(self, orm):
        # Deleting model 'DashboardInfo'
        db.delete_table('main_dashboardinfo')
