...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SectionCss'
        db.create_table('main_sectioncss', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section_css', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pagetree.Section'], unique=True)),
            ('css_field', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('main', ['SectionCss'])


    def backwards(self, orm):
        # Deleting model 'SectionCss'
        db.delete_table('main_sectioncss')
    ...
    models = {
        ...
        'main.sectioncss': {
            ...
            'css_field': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'section_css': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pagetree.Section']", 'unique': 'True'})
        },
        'main.userprofile': {
