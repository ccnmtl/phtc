...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.other_position_category'
        db.add_column('main_userprofile', 'other_position_category',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.other_position_category'
        db.delete_column('main_userprofile', 'other_position_category')
