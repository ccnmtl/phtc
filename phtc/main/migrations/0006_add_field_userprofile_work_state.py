...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.work_state'
        db.add_column('main_userprofile', 'work_state',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.work_state'
        db.delete_column('main_userprofile', 'work_state')
