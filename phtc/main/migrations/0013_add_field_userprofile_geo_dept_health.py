...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.geo_dept_health'
        db.add_column('main_userprofile', 'geo_dept_health',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.geo_dept_health'
        db.delete_column('main_userprofile', 'geo_dept_health')
