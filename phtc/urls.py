...
urlpatterns = patterns('',
                       ...
                       (r'^test_nynj_username/$','phtc.main.views.test_nynj_username'),
                       (r'^create_nynj_user/$','phtc.main.views.create_nynj_user'),
                       (r'^nynj_login/$','phtc.main.views.nynj_login'),
                       (r'^nynj/$','phtc.main.views.nynj'),
