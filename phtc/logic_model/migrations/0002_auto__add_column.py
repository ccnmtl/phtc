...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Column'
        db.create_table('logic_model_column', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('order_rank', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('css_classes', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
        ...
        db.send_create_signal('logic_model', ['Column'])


    def backwards(self, orm):
        # Deleting model 'Column'
        db.delete_table('logic_model_column')
    ...
    models = {
        ...
        'logic_model.column': {
            ...
            'order_rank': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
