...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.difficulty'
        db.alter_column('logic_model_scenario', 'difficulty', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Scenario.difficulty'
        db.alter_column('logic_model_scenario', 'difficulty', self.gf('django.db.models.fields.TextField')(null=True))
