...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('logic_model_activephase', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game_phase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logic_model.GamePhase'])),
            ('column', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logic_model.Column'])),
        ))
        db.send_create_signal('logic_model', ['ActivePhase'])

        # Adding unique constraint on 'ActivePhase', fields ['game_phase', 'column']
        db.create_unique('logic_model_activephase', ['game_phase_id', 'column_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ActivePhase', fields ['game_phase', 'column']
        db.delete_unique('logic_model_activephase', ['game_phase_id', 'column_id'])

        # Deleting model 'ActivePhase'
        db.delete_table('logic_model_activephase')
