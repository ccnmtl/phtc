...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.difficulty'
        db.add_column('logic_model_scenario', 'difficulty',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scenario.difficulty'
        db.delete_column('logic_model_scenario', 'difficulty')
    ...
    models = {
        ...
        'logic_model.scenario': {
            ...
            'difficulty': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
